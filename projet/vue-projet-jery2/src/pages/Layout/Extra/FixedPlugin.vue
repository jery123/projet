...
export default {
  data() {
    return {
      ...
      sidebarImages: [
        { image: require("@/assets/img/navkaran-singh-b-0-LM0wzWM-unsplash.jpg"), active: false },
        { image: require("@/assets/img/nathan-nugent-6AAptb2kBak-unsplash.jpg"), active: true },
