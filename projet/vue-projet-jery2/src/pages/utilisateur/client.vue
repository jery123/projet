...
<div v-if="currentClient">
 ...
 <!-- ======= Breadcrumbs Section ======= -->
    ...
    <md-card-content>
      <h6 class="category text-gray">Nom :{{currentClient.nom}}</h6>
      <h4 class="card-title">Prenom :{{currentClient.prenom}}</h4>
      <h4 class="card-title">Email :{{currentClient.email}}</h4>
      <h4 class="card-title">Ville :{{currentClient.ville}}</h4>
      <h4 class="card-title">Telephone :{{currentClient.telephone}}</h4>
     
      <p class="card-description">
       
       
      </p>
      <md-button class="md-round md-success" :href="'/modifierc/' + currentClient.id">Modifier</md-button>
    </md-card-content>
  </md-card>
