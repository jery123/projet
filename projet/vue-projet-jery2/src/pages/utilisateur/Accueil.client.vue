<template>
 ...
 <div> <v-row > <v-col cols="12" md="8"> <v-text-field v-model="nom" label="Search by Name"></v-text-field> </v-col>  <v-col cols="12" md="4"> <v-btn small @click="searchNom">
        Search
      </v-btn>
    </v-col>
      </v-row></div>
  <!-- <div id="entete" >
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" height="100">
  ...
  <div class="carousel-inner" height="100">
    <div class="carousel-item active">
      <img class="d-block w-50" src="../../assets/fullhd/15.jpg" height="100" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-50" src="../../assets/fullhd/5.jpg" height="100" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-50" src="../../assets/fullhd/7.jpg" height="100" alt="Third slide">
    </div>
  </div>
  ...
  <div >
    <h2 id="heade1"> Nos produits</h2>
          ...
          <div class="row row-cols-1 row-cols-md-4 g-4">
            <!-- <div class="col"> -->
              <div :class="{ active: index == currentIndex }" v-for="(produit, index) in produits" :key="index" @click="setActiveProduit(produit, index)" :href="'/produitfarm/' + produit.id" >
               <!-- <div class="col"> -->
                <!-- <div class="card"> -->
                <v-card class="col" max-width="344">
             <div class="card" data-toggle="modal" data-target="#modalProd" >  
                  ...
                  <div class="md-layout">
                    <div class="md-layout-item md-size-100">
                     <div class="places-buttons text-center">
                        ...
                        <md-button class="md-danger" @click="notifyVue('top','center')" data-dismiss="modal">Annuler</md-button>
                      <!-- <md-button class="md-info " @click="notifyVue('top','left')"  :href="'/detail/' + currentProduit.id" > Plus d'infos </md-button>
...
import 'bootstrap/dist/css/bootstrap.min.css'
 ...
 retrieveProduits() {
      ProduitDataService.findAllPublished()
        .then(response => {
